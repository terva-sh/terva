...
func PrintHelp(version string) {
	...
	section(i18n.T("commands — run `terva <command> --help` for detail"),
		...
		row{"terva ticket ...", i18n.T("work the repository's .tickets/ ledger (embedded git-ticket; `terva ticket help` lists commands)")},
	...
	section(i18n.T("workspace, tools, skills"),
		...
		row{"--no-ticket", i18n.T("drop the ticket_* tools and their guidance for this run; `terva ticket` still reaches the .tickets store")},
