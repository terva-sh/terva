...
// dialog (listInstalledExtensions → modes.ExtInfo). Live enable/disable is a
...
func extensionStatus(e modes.ExtInfo) string {
	switch {
	case e.Running:
		return "running"
	case e.ProjectGated:
...
func extensionNote(e modes.ExtInfo) string {
