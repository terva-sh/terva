...
describe('ModelPicker', () => {
  it('filters by model or provider and shows an empty result', () => {
    render(<ModelPicker groups={groups} favorites={[models[0]]} current="" onSwitch={() => {}} onToggleFavorite={() => {}} onSetDefault={() => {}} onClose={() => {}} />)
  ...
  it('marks the current model and routes selection with its provider', () => {
    ...
    render(<ModelPicker groups={groups} favorites={[]} current="model-b" onSwitch={onSwitch} onToggleFavorite={() => {}} onSetDefault={() => {}} onClose={() => {}} />)
  ...
  it('toggles favorites without selecting the model', () => {
    ...
    render(<ModelPicker groups={groups} favorites={[]} current="" onSwitch={onSwitch} onToggleFavorite={onToggleFavorite} onSetDefault={() => {}} onClose={() => {}} />)
  ...
  it('asks for a scope before setting a default, and never switches the session', () => {
    ...
    render(<ModelPicker groups={groups} favorites={[]} current="" onSwitch={onSwitch} onToggleFavorite={() => {}} onSetDefault={onSetDefault} onClose={() => {}} />)
  ...
  it('offers project scope, and lets the confirm be cancelled', () => {
    const onSetDefault = vi.fn()
    render(<ModelPicker groups={groups} favorites={[]} current="" onSwitch={() => {}} onToggleFavorite={() => {}} onSetDefault={onSetDefault} onClose={() => {}} />)
  ...
  it('marks the default model distinctly from the current one', () => {
    ...
    render(<ModelPicker groups={withDefault} favorites={[]} current="model-b" onSwitch={() => {}} onToggleFavorite={() => {}} onSetDefault={() => {}} onClose={() => {}} />)
  ...
  it('closes from Escape and the backdrop but not picker content', () => {
    const onClose = vi.fn()
    const { container } = render(<ModelPicker groups={groups} favorites={[]} current="" onSwitch={() => {}} onToggleFavorite={() => {}} onSetDefault={() => {}} onClose={onClose} />)
