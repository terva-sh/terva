...
const memoryDesc = "Keep a memory that stays after this session. The memory has two scopes and two tiers.\n\n" +
	...
	"One active entry holds at most 2048 characters. One archived entry holds at most 16384 bytes. The tool refuses a longer entry, and it saves nothing. Compose within the limit, or archive a pointer to a file.\n\n" +
