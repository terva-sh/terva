...
func ReadClipboardImagePNG() ([]byte, bool, error) {
	return nil, false, i18n.Errorf("clipboard image paste is not supported on this platform yet")
}
...
func WriteClipboardText(string) error {
	return i18n.Errorf("copying to the clipboard is not supported on this platform yet")
}
